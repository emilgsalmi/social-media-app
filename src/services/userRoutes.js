...
// Initiera UserDatabase och UserManager
...
router.get('/users', async (req, res) => {
    try {
        const users = await userDatabase.getAllUsers(); // Hämtar användare från databasen
        res.status(200).json(users); // Skickar användardatan som JSON
    } catch (error) {
